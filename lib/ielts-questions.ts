...
export const task1Questions: WritingQuestion[] = [
  ...
  },
  {
    ...
    imageAlt: 'Two simplified maps comparing a harbour area in 2005 and 2025.',
    structuredData: {
      changes: ['old warehouse replaced by apartments', 'new promenade', 'larger marina', 'bus stop added']
    }
  },
  {
